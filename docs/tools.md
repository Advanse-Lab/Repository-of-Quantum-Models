...
This document lists tools that can be used to create diagrams, implement quantum systems, and support modeling workflows.
...
* Supports UML and custom extensions
...
* Include source files for diagrams (e.g., `.puml`, `.drawio`)
